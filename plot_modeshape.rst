...
.. function:: vfo.plot_modeshape(model="none",modenumber=1,scale=10,setview="3D",contour="none",contourlimits=None,filename=None)
...
Example: 
   ...
   ``vfo.plot_modeshape(modenumber=3, scale=300)``
   ...
   ``vfo.plot_modeshape(modenumber=3, scale=300, model="TwoSpan_Bridge")``
